...
import { TogglebtnComponent } from "../../custom/togglebtn/togglebtn.component";
import { CardComponent } from "../../custom/card/card.component";

@Component({
  selector: 'app-resource',
  imports: [NavbarComponent, ResourceHeroComponent, RemoteCareerComponent, TogglebtnComponent, CardComponent],
